...
namespace Local\Bundles\TaskSchedulerBundle\Services;

use Psr\Log\LoggerInterface;
use Local\Bundles\TaskSchedulerBundle\Event\EventSubscriberInterface;
use Local\Bundles\TaskSchedulerBundle\Task\SchedulerEvents;
use Local\Bundles\TaskSchedulerBundle\Task\TaskInterface;

/**
 * Class SchedulerLogger
 * @package Local\Bundles\TaskSchedulerBundle\Services
