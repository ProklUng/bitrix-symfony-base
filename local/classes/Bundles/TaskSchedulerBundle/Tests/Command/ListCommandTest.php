...
namespace Local\Bundles\TaskSchedulerBundle\Tests\Command;

use Local\Bundles\TaskSchedulerBundle\Command\ListCommand;
use Local\Bundles\TaskSchedulerBundle\Task\Scheduler;
use Local\Bundles\TaskSchedulerBundle\Tests\DependencyInjection\ContainerAwareTest;
use Local\Bundles\TaskSchedulerBundle\Tests\TaskMock;
...
class ListCommandTest extends ContainerAwareTest {
  ...
  public function testListCommand() {
    ...
    $this->assertStringContainsString("| 1  | Local\Bundles\TaskSchedulerBundle\Tests\TaskMock |", $output);
  }
  ...
  public function testListCommandWithOption() {
    ...
    $this->assertStringContainsString("| 1  | Local\Bundles\TaskSchedulerBundle\Tests\TaskMock | nextRunDate, anotherRunDate", $output);
  }
}
