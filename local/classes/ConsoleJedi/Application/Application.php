...
namespace Local\ConsoleJedi\Application;

use Bitrix\Main\DB\ConnectionException;
use Bitrix\Main\Loader;
use Bitrix\Main\LoaderException;
use Bitrix\Main\ModuleManager;
use Local\ConsoleJedi\Application\Exception\ConfigurationException;
use Local\ConsoleJedi\Module\Command as Module;
...
class Application extends \Symfony\Component\Console\Application
{
    ...
    protected function getDefaultCommands()
    {
        ...
        $commands[] = new \Local\ConsoleJedi\Application\Command\InitCommand();
    ...
    protected function getBitrixCommands()
    {
        return array_merge(
            [
                new \Local\ConsoleJedi\Environment\Command\InitCommand(),
            ],
    ...
    public function initializeBitrix()
    {
        ...
        try {
            ...
            $DB, $DBType, $DBHost, $DBLogin, $DBPassword, $DBName, $DBDebug,
            $DBDebugToFile, $APPLICATION, $USER, $DBSQLServerType;
     ...
     *
     * @throws ConfigurationException|LoaderException
     */
