...
class CASDiblockPropCheckbox
{
    ...
    {
        $arPropertyFields = [
            'HIDE' => ['ROW_COUNT', 'COL_COUNT', 'MULTIPLE_CNT', 'WITH_DESCRIPTION'],
      ...
      <td><input type="text"
                 name="<?php echo $strHTMLControlName['NAME']; ?>[VIEW][<?php echo ASD_UT_CHECKBOX_VAL_FALSE; ?>]"
                 value="<?php echo htmlspecialcharsbx($arSettings['VIEW'][ASD_UT_CHECKBOX_VAL_FALSE]); ?>"></td>
      </tr>
      <tr>
      <td><?php echo GetMessage('ASD_UT_CHECKBOX_SETTING_VALUE_Y'); ?></td>
      <td><input type="text"
                 name="<?php echo $strHTMLControlName['NAME']; ?>[VIEW][<?php echo ASD_UT_CHECKBOX_VAL_TRUE; ?>]"
                 value="<?php echo htmlspecialcharsbx($arSettings['VIEW'][ASD_UT_CHECKBOX_VAL_TRUE]); ?>"></td>
      </tr><?php
    ...
    public static function GetPropertyFieldHtml($arProperty, $arValue, $strHTMLControlName): string
    {
        ...
        if (ASD_UT_CHECKBOX_VAL_TRUE != $value['VALUE']) { // WTF?!
            $value['VALUE'] = ASD_UT_CHECKBOX_VAL_FALSE;
        }
    ...
    public static function GetAdminFilterHTML($arProperty, $strHTMLControlName)
    {
        ...
        if (array_key_exists($strHTMLControlName['VALUE'],
                $_REQUEST) && (ASD_UT_CHECKBOX_VAL_TRUE == $_REQUEST[$strHTMLControlName['VALUE']] || ASD_UT_CHECKBOX_VAL_FALSE == $_REQUEST[$strHTMLControlName['VALUE']])) {
    ...
    {
        $arDefView = (new self)->GetDefaultListValues();
        $arView = [];
        if (
...
class CASDiblockPropCheckboxNum
{
    ...
    public static function GetSettingsHTML($arFields, $strHTMLControlName, &$arPropertyFields)
    {
      ...
      <td><input type="text"
                 name="<?php echo $strHTMLControlName['NAME']; ?>[VIEW][<?php echo ASD_UT_CHECKBOX_VAL_NUM_FALSE; ?>]"
                 value="<?php echo htmlspecialcharsbx($arSettings['VIEW'][ASD_UT_CHECKBOX_VAL_NUM_FALSE]); ?>"></td>
      </tr>
      <tr>
      <td><?php echo GetMessage('ASD_UT_CHECKBOX_NUM_SETTING_VALUE_Y'); ?></td>
      <td><input type="text"
                 name="<?php echo $strHTMLControlName['NAME']; ?>[VIEW][<?php echo ASD_UT_CHECKBOX_VAL_NUM_TRUE; ?>]"
                 value="<?php echo htmlspecialcharsbx($arSettings['VIEW'][ASD_UT_CHECKBOX_VAL_NUM_TRUE]); ?>"></td>
      </tr><?php
        $strResult = ob_get_contents();
        ob_end_clean();
    ...
    public static function GetAdminFilterHTML($arProperty, $strHTMLControlName)
    {
        ...
        $strCurValue = '';
        if (array_key_exists($strHTMLControlName['VALUE'],
                $_REQUEST) && (ASD_UT_CHECKBOX_VAL_NUM_TRUE == $_REQUEST[$strHTMLControlName['VALUE']] || ASD_UT_CHECKBOX_VAL_NUM_FALSE == $_REQUEST[$strHTMLControlName['VALUE']])) {
            $strCurValue = $_REQUEST[$strHTMLControlName['VALUE']];
